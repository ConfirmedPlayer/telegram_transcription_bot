...
- 🧠 Присылает в чат только краткую сводку длинных голосовых с учётом того, что и кто говорил в чате за последние 15 минут; полная расшифровка в чат не отправляется
...
4. **Получите ключи для сводок (бесплатно, без карты)**
   ...
   - Сводки работают и с одним ключом; без обоих бот в чат ничего не присылает
...
2. Отправьте ему голосовое сообщение на 1–2 минуты
3. Бот должен ответить краткой сводкой. Расшифровку он не присылает, а на сообщения короче 100 слов
   (порог `SUMMARY_MIN_WORDS`) не отвечает вовсе
